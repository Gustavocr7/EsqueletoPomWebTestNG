...
public class RunTestNG 
{
  ...
  public void mercadolibreTestNG(String producto,String url,String email,String generarReporte,String run) throws Exception 
  {
	  	if(run.equals("On")) {
  ...
  public void mercurytoursTestNG(String nombre,String apellido,String telefono,String email,
		  ...
		  String pais,String usuario,String pass,String confpass,String url,String generarEvidencia,String run) throws Exception 
  {
	  if(run.equals("On")) {
		//OBTENER EL NOMBRE DEL METODO A EJECUTAR
		String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
  ...
  public void ToolsQAAlertsTestNG(String url,String text,String generarReporte,String run) throws Exception 
  {
	  	if(run.equals("On")) {
	  		//OBTENER EL NOMBRE DEL METODO A EJECUTAR
			String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
  ...
  public void ToolsQAWidgetsTestNG(String url,String text,String generarReporte,String run) throws Exception 
  {
	  	if(run.equals("On")) {
	  		//OBTENER EL NOMBRE DEL METODO A EJECUTAR
			String nomTest = Thread.currentThread().getStackTrace()[1].getMethodName();
